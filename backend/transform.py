...
def main(input_pdf, summ):
    ...
    if summ == 1:
        ...
        summary = ''
    return docx_write(split_en_text, ru_text, summary, title, summ)
...
def docx_write(en_text, ru_text, summary, title, summ):
    """
    ...
    doc.add_paragraph()
    if summ == 1:
        summa = doc.add_paragraph("SUMMARY")
        summa.alignment = WD_ALIGN_PARAGRAPH.CENTER
    for part in summary:
